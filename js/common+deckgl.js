...
const wayFromTo = {
  ...
  const deckLayer = new DeckGlLeaflet.LeafletLayer({
    ...
    layers: [
      new deck.TileLayer({
        id: 'TileLayer',
        data: 'https://api.mapbox.com/styles/v1/mapbox/dark-v10/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoidmVyc3N0YWNoaSIsImEiOiJja3Q1bjI1OG0wYTB1MndwaG0wZTI0eG0yIn0.KW23CHoSsSdBk52ntlTaRA',
